...
async function getUniversityProfessors(request, response) {
  User.aggregate([
    {
      $match: { universityId: mongoose.Types.ObjectId(request.params.id) },
    },
    {
      $lookup: {
        from: "ratings",
...
module.exports = getUniversityProfessors;
